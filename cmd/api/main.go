...
import (
	...
	"github.com/Yangiboev/auth-example/internal/server"
	"github.com/Yangiboev/auth-example/pkg/db/aws"
	"github.com/Yangiboev/auth-example/pkg/db/postgres"
	"github.com/Yangiboev/auth-example/pkg/db/redis"
