...
import (
	...
	"github.com/Yangiboev/auth-example/docs"
	"github.com/Yangiboev/auth-example/pkg/csrf"

	"github.com/labstack/echo/v4"
	"github.com/labstack/echo/v4/middleware"
	echoSwagger "github.com/swaggo/echo-swagger"

	// _ "github.com/Yangiboev/auth-example/docs"
	authHttp "github.com/Yangiboev/auth-example/internal/auth/delivery/http"
	authRepository "github.com/Yangiboev/auth-example/internal/auth/repository"
	authUseCase "github.com/Yangiboev/auth-example/internal/auth/usecase"
	apiMiddlewares "github.com/Yangiboev/auth-example/internal/middleware"
	sessionRepository "github.com/Yangiboev/auth-example/internal/session/repository"
	"github.com/Yangiboev/auth-example/internal/session/usecase"
	"github.com/Yangiboev/auth-example/pkg/metric"
