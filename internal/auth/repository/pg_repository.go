...
func (r *authRepo) Register(ctx context.Context, user *models.User) (*models.User, error) {
	...
	u := &models.User{}
	if err := r.db.QueryRowxContext(ctx, createUserQuery, &user.Name, &user.Email, &user.Password).StructScan(u); err != nil {
...
func (r *authRepo) Update(ctx context.Context, user *models.User) (*models.User, error) {
	...
	u := &models.User{}
	if err := r.db.GetContext(ctx, u, updateUserQuery, &user.Name, &user.Email, &user.UserID); err != nil {
